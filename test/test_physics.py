...
class TestPhysics:
    ...
    def test_action_consistent_with_plaquette(self, beta, L):
    ...
    def test_plaquette_unitary_cold(self, mu, nv, NC, dtype):
    ...
    def test_plaquette_unitary_hot(self, mu, nv, NC, dtype):
    ...
    def test_force_hermitian(self, beta):
    ...
    def test_force_cold_start_zero(self, beta):
    ...
    def test_force_equals_gradient(self, mu, beta, L):
            ...
            for y in range(L):
                for z in range(L):
                    for t in range(L):
                        site = (x, y, z, t)
                        for a in range(8):
                            num = self._num_force_comp(U, mu, site, a, beta)
                            ana = self._ana_force_comp(F, mu, site, a)
                            assert num == pytest.approx(ana, abs=1e-7, rel=1e-5)

    def test_force_taylor_expansion(self, beta):
    ...
    def test_reunitarize_restores_unitary(self, seed, NC, dtype):
    ...
    def test_kinetic_energy_zero_at_zero(self, L, NC, dtype):
    ...
    def test_hamiltonian_is_T_plus_S(self, beta):
    ...
    def test_gauge_force_transforms_correctly(self, beta, NC):
